...
#### Hip, with Hyper-V virtualization

1. Download and Install Docker Desktop <https://www.docker.com/products/docker-desktop>
2. Verify that HYPER-V virtualization is enabled in the BIOS or UEFI  boot settings
3. Open Docker advanced settings and increase the memory limit for the Virtual machine to more than 4GB

#### Unhip, without Hyper-V virtualization

1. Download and Install Docker Toolbox <https://docs.docker.com/toolbox/toolbox_install_windows/>
2. Increase your virtual machine memory allocation
3. Note: You may have to use the IP address of your VM once it is set up, not localhost

### Mac

1. Download and Install Docker Desktop <https://www.docker.com/products/docker-desktop>
2. Open Docker advanced settings and increase the memory limit for the Virtual machine to more than 4 GB

## 2) Download the docker-compose.yml example

Download the example from  <https://raw.githubusercontent.com/wmde/wikibase-docker/master/docker-compose.yml>
...
If you want to access the blazegraph SPARQL endpoint directly for writing you need to bypass the read-only proxy.
You will need to make a change similar to this: <https://github.com/wmde/wikibase-docker/pull/16/files> to allow access to the Query Service Backend (Direct) @ <http://localhost:8999/bigdata/>](<http://localhost:8999/bigdata/>)
